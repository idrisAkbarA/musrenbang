      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-text-field
            ...
            outlined
            label="Password"
            hint="kosongkan untuk nilai default, default: <namakelurahan>123"
            :persistent-hint="true"
            @keyup="isPassVerified"
          ></v-text-field>
          <v-text-field
            @keyup="isPassVerified(); isPassVerified2();"
            type="password"
            v-model="passVerif"
            outlined
...
export default {
  ...
  methods: {
    ...
    isPassVerified(){
      (this.pass == this.passVerif) ? this.addButton = false : this.addButton = true;
    },
    isPassVerified2(){
      (this.pass == this.passVerif) ? this.isError = "" : this.isError = "password tidak cocok";
    },
    isDifference(item) {
